...
const mockTrades: Trade[] = [
  ...
  },
  {
    ...
    confluencesContro: ["Notizie in arrivo", "Bassa liquidità"],
    alignedTimeframes: [],
    barrier: [],
    imageUrls: [],
    notes: "Preso slippage in stop",
  },
  {
    id: "3",
    date: "2024-12-11",
    ...
    result: "breakeven",
    emotion: "Neutrale",
    confluencesPro: ["Pattern chiaro", "Livello chiave"],
    confluencesContro: [],
    alignedTimeframes: ["Daily"],
    barrier: ["m1"],
    imageUrls: [],
    notes: "Trade manuale pulito",
  },
  {
    id: "4",
    date: "2024-12-11",
